...
07:30  텔레그램 알림 발송
         ...
         ┌─ ✅ 네, 8시 출근  → 07:59 자동 출근 / 17:01 자동 퇴근
         ├─ ❌ 아니요, 9시   → 08:59 자동 출근 / 18:01 자동 퇴근
         ├─ 🌅 오후 반차     → 출근 시간 추가 선택 메시지 발송
         │     ├─ 8시 출근   → 07:59 자동 출근 / 12:01 자동 퇴근
         │     └─ 9시 출근   → 08:59 자동 출근 / 14:01 자동 퇴근
         ├─ 🏖️ 오늘 연차     → 출퇴근 체크 전체 건너뜀
         └─ 무응답           → 07:59 자동 출근 (기본값)

17:01  8:20 이전 출근자 자동 퇴근
18:01  8:20 이후 출근자 자동 퇴근
18:15  프로그램 자동 종료
